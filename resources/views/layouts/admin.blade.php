    ...
    <div class="tabs-responsive">
        <div class="tabs-container">
            <ul class="nav nav-tabs">
                <li id="tabl_billingaddfunds"><a href="/billing/#billingaddfunds"
                                                 onclick="changeTabSubmenu('billingaddfunds'); hidePostMessages();">Make
                        Payment</a></li>
            </ul>
        </div>
    </div>
    <a class="deploy_floating" href="/deploy/" title="Deploy New Server" aria-label="Deploy New Server"
       data-popup2="RGVwbG95IE5ldyBTZXJ2ZXI=">
...
<div class="block1290">
    ...
    <div class="info_message">You are almost ready to deploy servers - please link a payment method to get started!
    </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <label class="floatinglabel mobile-submenu-container flexwidth100">
                        ...
                        <select name="mobile-submenu" class="mobile-submenu no-search" style="display:none;"
                                data-xselect2="yes" data-minimum-results-for-search="-1"></select>
                    </label>

                    <div class="flex3column_left submenu" style="margin: 0px;">
                        <input type="radio" name="paymenttype" value="" id="paymenttype_creditcard"
                               class="tabmenu_radio" onchange="changeSideTabCustom(this);" data-tab="creditcard"/>
                        <label for="paymenttype_creditcard">
                            Credit Card
                        </label>
                        <input type="radio" name="paymenttype" value="" id="paymenttype_paypal" class="tabmenu_radio"
                               onchange="changeSideTabCustom(this);" data-tab="paypal"/>
                        <label for="paymenttype_paypal">
                            Paypal
                        </label>
                        <input type="radio" name="paymenttype" value="" id="paymenttype_bitpay" class="tabmenu_radio"
                               onchange="changeSideTabCustom(this);" data-tab="bitpay"/>
                        <label for="paymenttype_bitpay">
                            Bitcoin
                        </label>
                        <input type="radio" name="paymenttype" value="" id="paymenttype_alipay" class="tabmenu_radio"
                               onchange="changeSideTabCustom(this);" data-tab="alipay"/>
                        <label for="paymenttype_alipay">
                            Alipay
                        </label>
                        <input type="radio" name="paymenttype" value="" id="paymenttype_wechat" class="tabmenu_radio"
                               onchange="changeSideTabCustom(this);" data-tab="wechat"/>
                    ...
                    <div class="block520center">
                        ...
                        <div id="block_content_creditcard">
                            ...
                            <div data-panel="processor" data-processor="verisign">
                                <form method="post" action="/billing/" id="cc_form_unfunded"
                                      class="flexlayoutform flexlayout100p" data-billing_type="credit_card">
                                    <input type="hidden" name="csrf_token"
                                           value="rwomY1BiQzSut3APyOYQXdnjKglGu183a7IW/xt4iik=">
                                    ...
                                    <label class="floatinglabel flexwidth100">
                                        ...
                                        <input class="form-control" type="text" name="cc_name" value=""
                                               autocomplete="off" placeholder="Your Name" required="required">
                                    </label>
                                    <label class="floatinglabel flexwidth100">
                                        <span>Billing Address</span>
                                        <input class="form-control" type="text" name="cc_address" value=""
                                    ...
                                    <label class="floatinglabel flexwidth1thirdcc responsiveccfullwidth">
                                        ...
                                        <input class="form-control" type="text" name="cc_city" value=""
                                               placeholder="Billing City" required="required">
                                    </label>
                                    <label class="floatinglabel flexwidth1thirdcc responsiveccfullwidth">
                                        <span>Billing Postal Code</span>
                                        <input class="form-control" type="text" name="cc_zip" value=""
                                               placeholder="Billing Postal Code" required="required">
                                    </label>
                                    <label class="floatinglabel flexwidth1thirdcc responsiveccfullwidth">
                                    ...
                                    <label class="floatinglabel flexwidthhalfcc responsiveccfullwidth card-number card-number-color">
                                        ...
                                        <input class="form-control valid_cc_number" type="text" name="cc_number"
                                               value="" autocomplete="off" placeholder="Card Number" required>
                                        <i></i>
                                    ...
                                    <label class="floatinglabel flexwidthquartercc responsiveccfullwidth expiry-date">
                                        <span>MM/YY</span>
                                        <input class="form-control valid_inputCardExpiry" type="text" name="cc_expiry"
                                               value="" placeholder="MM/YY" autocomplete="off" maxlencc_expirygth="7"
                                               required>
                                        <i></i>
                                    ...
                                    <label class="floatinglabel flexwidthquartercc responsiveccfullwidth cvv-number">
                                        <span>CVV</span>
                                        <input class="form-control valid_cc_cscv integers_only" type="text"
                                               name="cc_cscv" value="" autocomplete="off" placeholder="CVV"
                                    ...
                                    <input type="checkbox" name="link_credit_card" id="link_credit_card"
                                           class="checkboxcheckmark" onchange="initialize_unfunded_cc_link();"/>
                                    <label for="link_credit_card">I just want to link my credit card - <b>$0.00
                                            deposit</b></label>
                                    <hr class="hr20">
                                    <input type="radio" name="amount" value="10" id="cce10" class="radiolabelbutton"
                                           onchange="unfundedccupdate();"/>
                                    <label for="cce10" class="flexwidth1sixth">
                                        $10
                                    </label>
                                    <input type="radio" name="amount" value="25" id="cce25" class="radiolabelbutton"
                                           onchange="unfundedccupdate();"/>
                                    <label for="cce25" class="flexwidth1sixth">
                                        $25
                                    </label>
                                    <input type="radio" name="amount" value="50" id="cce50" class="radiolabelbutton"
                                           onchange="unfundedccupdate();"/>
                                    <label for="cce50" class="flexwidth1sixth">
                                        $50
                                    </label>
                                    <input type="radio" name="amount" value="100" id="cce100" class="radiolabelbutton"
                                           onchange="unfundedccupdate();"/>
                                    <label for="cce100" class="flexwidth1sixth">
                                        $100
                                    </label>
                                    <input type="radio" name="amount" value="250" id="cce250" class="radiolabelbutton"
                                           onchange="unfundedccupdate();"/>
                                    <label for="cce250" class="flexwidth1sixth">
                                        $250
                                    </label>
                                    <input type="radio" name="amount" value="other" id="cceother"
                                           class="radiolabelbutton" onchange="unfundedccupdate();">
                                    <label for="cceother" class="flexwidth1sixth">
                                        <i class="zmdi zmdi-plus-circle-o"></i>
                                        <span class="hide_on_mobile">Other</span>
                                    </label>
                                    <div id="unfunded-other-amount-block"
                                         class="form-group form-select-input m-t-20 m-b-0 w100p other-amount"
                                         style="display:none;">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input name="amountcustom" type="text" id="cc-unfunded-amount"
                                                   class="form-control numbers_only" placeholder="Enter amount"
                                                   maxlength="8" autocomplete="off">
                                        </div>
                                    </div>
                                    <hr class="hr20"/>
                                    <div>
                                        <input type="checkbox" name="agree_tos" id="agree_tos_creditcard"
                                               class="checkboxcheckmark"/>
                                        <label for="agree_tos_creditcard" class="flexwidth100">I Agree to the <a
                                                    href="https://www.vultr.com/legal/tos.php" target="_blank">Terms of
                                                Service</a></label>
                                    </div>
                                    <hr class="hr30"/>
                                    <button type="submit" class="flexwidth100 button nodisabled">Link Credit Card
                                    </button>
                                </form>
                                <iframe width=1 height=1 frameborder=0 scrolling=no
                                        src='https://my.vultr.com/billing/frame.php?m=165400&s=1544782448gKo1X'><img
                                            width=1 height=1
                                            src='https://my.vultr.com/billing/framelogo.php?m=165400&s=1544782448gKo1X'>
                                </iframe>
                            </div>
                        ...
                        <div id="block_content_paypal" style="display:none;">
                            ...
                            <div data-panel="processor" data-processor="paypal">
                                <form method="post" name="paypal_form" id="paypal_form"
                                      class="flexlayoutform flexlayout100p" action="/billing/paypal.php"
                                      data-billing_type="paypal">
                                    <input type="hidden" name="csrf_token"
                                           value="rwomY1BiQzSut3APyOYQXdnjKglGu183a7IW/xt4iik=">


                                    <input type="radio" name="amount" value="10" class="radiolabelbutton" id="paypal10"
                                           onchange="paypalamountchange();">
                                    <label for="paypal10" class="flexwidth1sixth">
                                        $10
                                    </label>
                                    <input type="radio" name="amount" value="25" class="radiolabelbutton" id="paypal25"
                                           onchange="paypalamountchange();">
                                    <label for="paypal25" class="flexwidth1sixth">
                                        $25
                                    </label>
                                    <input type="radio" name="amount" value="50" class="radiolabelbutton" id="paypal50"
                                           onchange="paypalamountchange();">
                                    <label for="paypal50" class="flexwidth1sixth">
                                        $50
                                    </label>
                                    <input type="radio" name="amount" value="100" class="radiolabelbutton"
                                           id="paypal100" onchange="paypalamountchange();">
                                    <label for="paypal100" class="flexwidth1sixth">
                                        $100
                                    </label>
                                    <input type="radio" name="amount" value="250" class="radiolabelbutton"
                                           id="paypal250" onchange="paypalamountchange();">
                                    <label for="paypal250" class="flexwidth1sixth">
                                        $250
                                    </label>

                                    <input type="radio" name="amount" value="other" id="paypalother"
                                           class="radiolabelbutton" onchange="paypalamountchange();">
                                    <label for="paypalother" class="flexwidth1sixth">
                                        <i class="zmdi zmdi-plus-circle-o"></i>
                                        <span class="hide_on_mobile">Other</span>
                                    </label>
                                    <div id="other-amount-block-paypal"
                                         class="form-group form-select-input m-t-20 m-b-0 w100p other-amount"
                                         style="display:none;">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input name="amountcustom" type="text" id="paypal-custom-amount"
                                                   class="form-control numbers_only" value="" placeholder="Enter amount"
                                                   maxlength="8" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <hr class="hr20"/>
                                    <div>
                                        <input type="checkbox" name="agree_tos" id="agree_tos_paypal"
                                               class="checkboxcheckmark"/>
                                        <label for="agree_tos_paypal" class="flexwidth100">I Agree to the <a
                                                    href="https://www.vultr.com/legal/tos.php" target="_blank">Terms of
                                                Service</a></label>
                                    </div>

                                    <hr class="hr30"/>
                                    <button type="submit" class="button flexwidth100"
                                            onclick="submitPayment($(this)); return false;">Pay with PayPal
                                    </button>
                                </form>
                            </div>
                        ...
                        <div id="block_content_bitpay" style="display:none;">
                            ...
                            <div data-panel="processor" data-processor="bitpay">
                                ...
                                <hr class="hr30"/>
                                <form method="post" name="bitpay_form" id="bitpay_form"
                                      class="flexlayoutform flexlayout100p" action="/billing/bitpay.php"
                                      data-billing_type="bitpay">
                                    <input type="hidden" name="action" value="makepayment">
                                    <input type="hidden" name="csrf_token"
                                           value="rwomY1BiQzSut3APyOYQXdnjKglGu183a7IW/xt4iik=">

                                    <input type="radio" name="amount" value="10" class="radiolabelbutton" id="bitcoin10"
                                           onchange="bitcoinamountchange();">
                                    <label for="bitcoin10" class="flexwidth1sixth">
                                        $10
                                    </label>
                                    <input type="radio" name="amount" value="25" class="radiolabelbutton" id="bitcoin25"
                                           onchange="bitcoinamountchange();">
                                    <label for="bitcoin25" class="flexwidth1sixth">
                                        $25
                                    </label>
                                    <input type="radio" name="amount" value="50" class="radiolabelbutton" id="bitcoin50"
                                           onchange="bitcoinamountchange();">
                                    <label for="bitcoin50" class="flexwidth1sixth">
                                        $50
                                    </label>
                                    <input type="radio" name="amount" value="100" class="radiolabelbutton"
                                           id="bitcoin100" onchange="bitcoinamountchange();">
                                    <label for="bitcoin100" class="flexwidth1sixth">
                                        $100
                                    </label>
                                    <input type="radio" name="amount" value="250" class="radiolabelbutton"
                                           id="bitcoin250" onchange="bitcoinamountchange();">
                                    <label for="bitcoin250" class="flexwidth1sixth">
                                        $250
                                    </label>

                                    <input type="radio" name="amount" value="other" id="bitcoinother"
                                           class="radiolabelbutton" onchange="bitcoinamountchange();">
                                    <label for="bitcoinother" class="flexwidth1sixth">
                                        Other
                                    </label>

                                    <div id="other-amount-block-bitcoin"
                                         class="form-group form-select-input m-t-20 m-b-0 w100p other-amount"
                                         style="display:none;">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input name="amountcustom" type="text" id="bitcoin-custom-amount"
                                                   class="form-control numbers_only" value="" placeholder="Enter amount"
                                                   maxlength="8" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <hr class="hr30"/>
                                    <button type="submit" class="button flexwidth100"
                                            onclick="submitPayment($(this)); return false;">Pay with Bitcoin
                                    </button>
                                </form>
                            </div>
                        ...
                        <div id="block_content_alipay" style="display:none;">
                            ...
                            <div data-panel="processor" data-processor="stripe">
                                <form method="post" name="alipay_form" id="alipay_form"
                                      class="flexlayoutform flexlayout100p" action="/billing/alipay.php"
                                      data-billing_type="alipay">
                                    <input type="hidden" name="method" value="alipay">
                                    <input type="hidden" name="action" value="makepayment">
                                    <input type="hidden" name="csrf_token"
                                           value="rwomY1BiQzSut3APyOYQXdnjKglGu183a7IW/xt4iik=">

                                    <input type="radio" name="amount" value="10" class="radiolabelbutton" id="alipay10"
                                           onchange="alipayamountchange();">
                                    <label for="alipay10" class="flexwidth1sixth">
                                        $10
                                    </label>
                                    <input type="radio" name="amount" value="25" class="radiolabelbutton" id="alipay25"
                                           onchange="alipayamountchange();">
                                    <label for="alipay25" class="flexwidth1sixth">
                                        $25
                                    </label>
                                    <input type="radio" name="amount" value="50" class="radiolabelbutton" id="alipay50"
                                           onchange="alipayamountchange();">
                                    <label for="alipay50" class="flexwidth1sixth">
                                        $50
                                    </label>
                                    <input type="radio" name="amount" value="100" class="radiolabelbutton"
                                           id="alipay100" onchange="alipayamountchange();">
                                    <label for="alipay100" class="flexwidth1sixth">
                                        $100
                                    </label>
                                    <input type="radio" name="amount" value="250" class="radiolabelbutton"
                                           id="alipay250" onchange="alipayamountchange();">
                                    <label for="alipay250" class="flexwidth1sixth">
                                        $250
                                    </label>

                                    <input type="radio" name="amount" value="other" id="alipayother"
                                           class="radiolabelbutton" onchange="alipayamountchange();">
                                    <label for="alipayother" class="flexwidth1sixth">
                                        <i class="zmdi zmdi-plus-circle-o"></i>
                                        <span class="hide_on_mobile">Other</span>
                                    </label>

                                    <div id="other-amount-block-alipay"
                                         class="form-group form-select-input m-t-20 m-b-0 w100p other-amount"
                                         style="display:none;">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input name="amountcustom" type="text" id="alipay-custom-amount"
                                                   class="form-control numbers_only" value="" placeholder="Enter amount"
                                                   maxlength="8" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <hr class="hr20"/>
                                    <div>
                                        <input type="checkbox" name="agree_tos" id="agree_tos_alipay"
                                               class="checkboxcheckmark"/>
                                        <label for="agree_tos_alipay">I Agree to the <a
                                                    href="https://www.vultr.com/legal/tos.php" target="_blank">Terms of
                                                Service</a></label>
                                    </div>
                                    ...
                                    <hr class="hr30"/>
                                    <button type="submit" class="button flexwidth100"
                                            onclick="submitPayment($(this)); return false;">Pay with Alipay
                                    </button>
                                </form>
                            </div>
                        ...
                        <div id="block_content_wechat" style="display:none;">
                            ...
                            <div data-panel="processor" data-processor="stripe">
                                <form method="post" name="wechat_form" id="wechat_form"
                                      class="flexlayoutform flexlayout100p" action="/billing/wechat.php"
                                      data-billing_type="wechat">
                                    <input type="hidden" name="method" value="wechat">
                                    <input type="hidden" name="action" value="makepayment">
                                    <input type="hidden" name="csrf_token"
                                           value="rwomY1BiQzSut3APyOYQXdnjKglGu183a7IW/xt4iik=">

                                    <input type="radio" name="amount" value="10" class="radiolabelbutton" id="wechat10"
                                           onchange="wechatamountchange();">
                                    <label for="wechat10" class="flexwidth1sixth">
                                        $10
                                    </label>
                                    <input type="radio" name="amount" value="25" class="radiolabelbutton" id="wechat25"
                                           onchange="wechatamountchange();">
                                    <label for="wechat25" class="flexwidth1sixth">
                                        $25
                                    </label>
                                    <input type="radio" name="amount" value="50" class="radiolabelbutton" id="wechat50"
                                           onchange="wechatamountchange();">
                                    <label for="wechat50" class="flexwidth1sixth">
                                        $50
                                    </label>
                                    <input type="radio" name="amount" value="100" class="radiolabelbutton"
                                           id="wechat100" onchange="wechatamountchange();">
                                    <label for="wechat100" class="flexwidth1sixth">
                                        $100
                                    </label>
                                    <input type="radio" name="amount" value="250" class="radiolabelbutton"
                                           id="wechat250" onchange="wechatamountchange();">
                                    <label for="wechat250" class="flexwidth1sixth">
                                        $250
                                    </label>

                                    <input type="radio" name="amount" value="other" id="wechatother"
                                           class="radiolabelbutton" onchange="wechatamountchange();">
                                    <label for="wechatother" class="flexwidth1sixth">
                                        <i class="zmdi zmdi-plus-circle-o"></i>
                                        <span class="hide_on_mobile">Other</span>
                                    </label>

                                    <div id="other-amount-block-wechat"
                                         class="form-group form-select-input m-t-20 m-b-0 w100p other-amount"
                                         style="display:none;">
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input name="amountcustom" type="text" id="wechat-custom-amount"
                                                   class="form-control numbers_only" value="" placeholder="Enter amount"
                                                   maxlength="8" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <hr class="hr20"/>
                                    <div>
                                        <input type="checkbox" name="agree_tos" id="agree_tos_wechat"
                                               class="checkboxcheckmark"/>
                                        <label for="agree_tos_wechat">I Agree to the <a
                                                    href="https://www.vultr.com/legal/tos.php" target="_blank">Terms of
                                                Service</a></label>
                                    </div>
                                    ...
                                    <hr class="hr30"/>
                                    <button type="submit" class="button flexwidth100"
                                            onclick="submitPayment($(this)); return false;">Generate QR Code
                                    </button>
                                    <hr class="hr30"/>
                                    ...
                                    <div class="panel panel-bordered qrcode-panel" style="display:none;">
                                        <div class="panel-body">
                                            <div class="tab-section tab-section-sm">
                                                ...
                                                <div class="panel">
                                                    <div class="panel-body">
                                                        <h6 class="panel-title title-faded" align="center">Scan the QR
                                                            code with your app to make a <b>$0.00</b> WeChat payment
                                                        </h6>
                        ...
                        <div data-id="cart_credit_card" style="position: relative">
                            ...
                            <div data-id="cart_container">
                                <div class="cart">
                                    ...
                                    <span class="spinner spinner-lg spinner-white" data-id="spinner"
                                    ...
                                    <table class="billingcart">
                                        ...
                                        <tr class="billingcartform">
                                            <td>
                                                <input type="text" class="alternate flexwidth100" name="gift_code"
                                    ...
                                    <div class="billingcart_bl" style="display: none;">
                                        This payment method is not eligible for promotions at the current time. You may
                                        use our promo codes with other payment methods.
                                    </div>
...
<div class="dropdown-confirmation dropdown-confirmation-blue">
    ...
    <div class="dropdown-actions">
        ...
        <button class="btn btn-xs btn-default btn-outline btn-block" data-dismiss="drop" onclick="hideDropdowns();">
            Cancel
        </button>
    </div>
</div>
...
<div class="dropdown-confirmation dropdown-confirmation-blue-checkbox">
    ...
    <div class="dropdown-actions">
        <a class="btn btn-xs btn-dropdown-blue btn-primary btn-block btn-confirmation btn-confirmation-blue"
           disabled></a>
        <button class="btn btn-xs btn-default btn-outline btn-block" data-dismiss="drop" onclick="hideDropdowns();">
            Cancel
        </button>
